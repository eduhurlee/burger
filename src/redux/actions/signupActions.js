...
export const signupUser = (email, password) => {
  return function(dispatch) {
    ...
    axios
      .post(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyB8n9dp0FNd2CCxFgsu7muzcLDa3UMfgOs",
        data
      )
      .then(result => {
...
export const autoLogoutAfterMillisec = ms => {
  return function(dispatch) {
    ...
    // axios
    //   .post(
    //     "https://securetoken.googleapis.com/v1/token?key=AIzaSyB8n9dp0FNd2CCxFgsu7muzcLDa3UMfgOs",
    //     {
